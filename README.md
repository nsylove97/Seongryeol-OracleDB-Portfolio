...
- DBMS_DBCOMP.DBCOMP — Primary–Standby 데이터파일 블록 SCN 단위 비교 / 특정 파일 번호 또는 ALL 인자 사용
...
- Physical → Logical Standby 전환 복습 — DBMS_LOGSTDBY.BUILD → ARCHIVE LOG CURRENT → RECOVER TO LOGICAL STANDBY
